...
export const NAME = process.env.NAME || "ops-fulfillment";
...
export const KAFKA_CONSUMER_TOPIC_NAME = process.env.KAFKA_CONSUMER_TOPIC_NAME || `order-central-fulfillment`;
