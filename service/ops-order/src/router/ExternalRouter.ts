...
import { CreateOrderRequestSchema } from "../schema/ExternalSchemas.js";
...
export const initializeExternalRouters = function (app: Express) {
    ...
    // ==============================================================================
    router.post("/v1/orders/create", validate({ body: CreateOrderRequestSchema }), externalController.createOrder);
    // ==============================================================================
